use crate::model::{
    ClipState, GraphicsKind, GraphicsObject, PaintOpacity, ReconstructionDecision, Rect, TextFailureReason, TextObject,
    VisibilityDecision,
};
    ...
    for text_object in text_objects {
        ...
        text_object.reconstruction = match visibility {
            ...
            VisibilityDecision::CoveredByOpaquePaint => {
                ReconstructionDecision::TextFailure(TextFailureReason::CoveredByOpaquePaint)
            }
            VisibilityDecision::AmbiguousVisibility => {
                ReconstructionDecision::TextFailure(TextFailureReason::AmbiguousVisibility)
            }
        };
    }
}
